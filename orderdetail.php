...
?>
 ...
 <div class="card">
            ...
            <div class="card-header">
             ...
             <center><h2>vishal's Cake Shop</h2><p style="font-size: 20px">IMCC project City <br> Semester2</p></center>
         </div>
...
//mysqli_select_db($myConnection,"cakes") or die ("no database");        
            ...
            $result = mysqli_query($myConnection, "SELECT * FROM tbltransacdetail 
              WHERE transac_code =".$_GET['id']) or die(mysqli_error($myConnection));
              while($row = mysqli_fetch_array($result))
              {   
               $stats = $row['status'];
              }
